...
%   * fix some prompts
%  24Aug22: use bone_scint_select.
%
%    See also:  FFDM_BTC_CALC_GEN, BTC_DEFINE, BONE_PSPEC_DEMO, GLIDER_MAPUBI, BONE_SCINT_SELECT.
%
...
file_name=getinp('database file name','s',[0 1],file_name);
